...
class Client:
    ...
    def __init__(self, private_key, public_key, client_cert, ca, sckt=None, server_name=None):
        self.sckt = sckt
        self.msg_cnt = 0
    ...
    def process(self, msg=b""):
        ...
        if (self.msg_cnt == 0):
            ...
            if (self.msg_cnt == 1):
                ...
                self.server_name = server_cert.get_subject()
            ...
            if (server_cert.get_subject()==self.server_name):    
...
def tcp_echo_client(loop=None):
    ...
    clientep12 = genClientCertificate()

    reader, writer = yield from asyncio.open_connection('127.0.0.1',
                                                        conn_port, loop=loop)
    addr = writer.get_extra_info('peername')

    cliente = crypto.load_pkcs12(open(clientep12, "rb").read(),b'1234')
    ...
    try:
        ...
        client = Client(private_key,public_key,client_cert,ca_cert,addr)
        msg = client.process()
        while msg:
            writer.write(msg)
