...
import sys
import OpenSSL
from genCertificates import genClientCertificate
...
class ServerWorker(object):
    ...
    def __init__(self, cnt, private_key, public_key, server_cert, ca, addr=None,client_name=None):
        self.id = cnt
        self.msg_cnt = 0
        self.addr = addr
    ...
    def process(self, msg):
        ...
        if (self.msg_cnt == 0):
            ...
            self.client_name = client_cert.get_subject()
            ...
            if (client_cert.get_subject()==self.client_name):
...
def handle_echo(reader, writer):
    ...
    serverp12 = genClientCertificate()

    server = crypto.load_pkcs12(open(serverp12, "rb").read(), b'1234')
    ...
    try:
        ...
        srvwrk = ServerWorker(conn_cnt,private_key,public_key,server_cert,ca_cert,addr,None)
